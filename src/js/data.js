...
const QUESTIONS = [{ imageSources: [], rightAnswers: [] }, { imageSources: [], rightAnswers: [] },
	{ imageSources: [], rightAnswers: [] }, { imageSources: [], rightAnswers: [] }, { imageSources: [], rightAnswers: [] },
	{ imageSources: [], rightAnswers: [] }, { imageSources: [], rightAnswers: [] }, { imageSources: [], rightAnswers: [] },
	{ imageSources: [], rightAnswers: [] }, { imageSources: [], rightAnswers: [] }];
		...
		case `one-of-three`:
			question[`answers`].forEach((answer, j) => {
				if (answer[`type`] === `photo`
					&& question[`question`].split(` `)[1] === `фото`) {
					QUESTIONS[index][`rightAnswers`][0] = j;
				} else if (answer[`type`] === `painting`
					&& question[`question`].split(` `)[1] === `рисунок`) {
					QUESTIONS[index][`rightAnswers`][0] = j;
				}
